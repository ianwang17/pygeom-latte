...
version = importlib.metadata.version("pygeom-latte")
...
html_theme = "furo"
html_theme_options = {
    "source_repository": "https://github.com/legend-exp/pygeom-latte",
    "source_branch": "main",
...
intersphinx_mapping = {
    ...
    "legend1000": ("https://legend-pygeom-l1000.readthedocs.io/en/latest/", None),
