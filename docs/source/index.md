...
It's recommended to install this package in an environment used to run remage. See [remage](https://remage.readthedocs.io/en/stable/) installation instructions for walk-through instructions to set up an appropriate virtual environment or container.

Once in that environment, this packages's development version can be installed from a git
